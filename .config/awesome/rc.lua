...
-- Wallpaper
-- gears.wallpaper.maximized("/home/zero/Pictures/Wallpaper/fog_forest_alt_2.png", 1, true)
...
beautiful.init(gears.filesystem.get_themes_dir() .. "Gruv/theme.lua")
beautiful.init("~/.config/awesome/Gruv/theme.lua")
...
globalkeys = awful.util.table.join(
	...
	awful.key({ "Mod4" }, "Shift_L", function()
		kbdcfg.switch_next()
	end)
)
...
--add widget
praisewidged = wibox.widget.textbox()
